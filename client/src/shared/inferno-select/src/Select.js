...
const Select = createClass({
			...
			return (
				<div
					...
					aria-activedescendant={
						isOpen ? this._instancePrefix + '-option-' + focusedOptionIndex : this._instancePrefix + '-value'
					}
					className={className}
	...
	render() {
		...
		let className = classNames('Select input select-input', this.props.className, {
		...
		let SelectClassName = classNames('Select-control', this.props.className);
