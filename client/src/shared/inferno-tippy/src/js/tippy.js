...
class Tippy {
    ...
    updateForReact(popper, updatedContent) {
        ...
        const { useContext, reactInstance } = ref.settings;
    ...
    show(popper, customDuration) {
        ...
        const {
            el,
            settings: { appendTo, sticky, interactive, followCursor, flipDuration, duration }
        } = ref;

        const _duration =
            customDuration !== undefined ? customDuration : Array.isArray(duration) ? duration[0] : duration;
    ...
    hide(popper, customDuration) {
        ...
        const {
            el,
            settings: { appendTo, sticky, interactive, followCursor, html, trigger, duration }
        } = ref;

        const _duration =
            customDuration !== undefined ? customDuration : Array.isArray(duration) ? duration[1] : duration;
    ...
    destroy(popper, _isLast) {
        ...
        el.setAttribute(
            'title',
            el.getAttribute('data-original-title') !== 'html' ? el.getAttribute('data-original-title') : ''
        );
