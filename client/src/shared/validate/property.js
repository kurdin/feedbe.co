...
function required (bool) {
  return function (value) {
    if (typeOf(value) === 'array') return value.length === 0 ? false : true;
    if (typeOf(value) === 'object') return Object.keys(value).length === 0 ? false : true;
...
function type (name) {
  return function (value) {
    if (name === 'array') return value === null || Array.isArray(value);
