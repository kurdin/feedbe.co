 ...
 * @param {Object} props
 */
export function OverlayComponent({ input, selectedDay, month, children, classNames, ...props }) {
  return (
...
export default class DayPickerInput extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (dayPickerProps.month && dayPickerProps.month !== prevMonth && !isSameMonth(dayPickerProps.month, prevMonth)) {
  ...
  handleDayClick(day, modifiers, e) {
    ...
    if (modifiers.selected && clickUnselectsDay) {
      ...
      this.setState({ value: '', typedValue: undefined, selectedDays }, this.hideAfterDayClick);
      if (onDayChange) {
  ...
  renderOverlay() {
    ...
    if (dayPickerProps.todayButton) {
      ...
      onTodayButtonClick = () =>
        this.updateState(new Date(), formatDate(new Date(), format, dayPickerProps.locale), this.hideAfterDayClick);
    }
