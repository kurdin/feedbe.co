...
const CustomerViews = t.enumeration(['dark', 'light', 'reverse', 'imageOnly']);
...
const Provider = t.model('Provider', {
  ...
  faciltyType: t.enumeration(['day care', 'private apartment', 'private house', 'after school', 'private townhouse', 'kids zone', 'sport club', 'commercial property', 'public place']),
...
export { User, Provider, Filter, Event };
