...
module.exports = {
	...
	entry: {
		wcrapp: [
			'./webcorrector-app',
			process.env.NODE_ENV != 'production' ? 'webpack-dev-server/client?http://localhost:8080' : './webcorrector-app'
		]
	...
	resolve: {
		alias: {
			...
			dust: path.join(__dirname, 'local_modules/dustjs-linkedin/lib/dust.js'),
			'jflux-dust': path.join(__dirname, 'local_modules/jflux-dust/releases/jflux-dust-latest.js'),
			// 'jflux-dust': path.join(__dirname, 'local_modules/jflux-dust/src/jflux.js'),
